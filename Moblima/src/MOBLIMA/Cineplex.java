...
public class Cineplex { 
	 ...
	 * sets the name and id of the cineplex and creates a new list of Cinemas for the Cineplex
	 ...
	 * Allows for a list of cinemas to be set for the Cineplex instead of creating a new list
	 * @param nameCineplex Name of this cineplex
	 * @param idCineplex ID of this Cineplex
