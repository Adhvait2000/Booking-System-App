...
/**
 * Represents a movie goer/customer and relevant information for booking
 * purposes
...
public class MovieGoer {
	 ...
	 * Necessary to check if booking already exists in list of bookings made by the
	 * customer, if not proceed to add the booking
	 * 
