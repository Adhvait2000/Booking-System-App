...
/**
  ...
  The dates are retrieved from a data file and modifications are written directly to the file
  @version 1.0
  @since 2022-11-02
 */
...
public class PublicHolidayIO {
	 ...
	 * @throws IOException
	 * @throws Exception 
	 * @return public holiday date if reading is successful, or an empty string if there are no more dates or if an exception error has occurred
	 */
